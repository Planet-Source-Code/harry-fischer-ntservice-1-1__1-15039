========================================================================
		ActiveX Control DLL : NTSVC
========================================================================

ControlWizard has created this project for your NTSVC ActiveX Control
...
that make up your NTSVC ActiveX Control DLL.
...
NtsvcCtl.h
	This file contains the declaration of the CNtsvcCtrl C++ class.

NtsvcCtl.cpp
	This file contains the implementation of the CNtsvcCtrl C++ class.

NtsvcPpg.h
	This file contains the declaration of the CNtsvcPropPage C++ class.

NtsvcPpg.cpp
	This file contains the implementation of the CNtsvcPropPage C++ class.

NtsvcCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CNtsvcCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Ntsvc.rc.
